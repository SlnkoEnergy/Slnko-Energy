...
const HimachalPradesh = () => {
  const geoUrl = process.env.PUBLIC_URL + "/maps/HimachalPradesh.geojson";
  ...
  const districtWpData = {
    Shimla: { wp: "8.20 MWp", status: "completed" },
    Solan: { wp: "7.36 MWp", status: "completed" },
  };
          ...
          <Box width="100%" sx={{ aspectRatio: "4 / 3", maxWidth: "2000px" }}>
            <Suspense fallback={<CircularProgress color="primary" />}>
              <ComposableMap
                ...
                projectionConfig={{ scale: 9000, center: [76.85, 31.85] }}
