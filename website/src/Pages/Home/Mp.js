...
const MadhyaPradeshMap = () => {
  ...
  const districtWpData = {
    Rajgarh: { wp: "27.40 MWp", status: "ongoing" },
    Mandsaur: { wp: "2.0 MWp", status: "completed" },
    Ujjain: { wp: "2.2 MWp", status: "completed" },
    "Khargone (West Nimar)": { wp: "9.0 MWp", status: "ongoing" },
    Raisen: { wp: "4.40 MWp", status: "ongoing" },
    Chhindwara: { wp: "1.20 MWp", status: "ongoing" },
    Narsinghpur: { wp: "2.0 MWp", status: "completed" },
    Seoni: { wp: "3.60 MWp", status: "ongoing" },
    Jabalpur: { wp: "6.0 MWp", status: "ongoing" },
    Shahdol: { wp: "2.0 MWp", status: "completed" },
    Sidhi: { wp: "3.60 MWp", status: "ongoing" },
    Rewa: { wp: "2.0 MWp", status: "completed" },
    Chhatarpur: { wp: "4.80 MWp", status: "ongoing" },
    Sagar: { wp: "27.80 MWp", status: "ongoing" },
    Niwari: { wp: "1.20 MWp", status: "completed" },
    Singrauli: { wp: "2.70 MWp", status: "ongoing" },
    Barwani: { wp: "1.20 MWp", status: "ongoing" },
    Damoh: { wp: "2.0 MWp", status: "completed" },
    Dhar: { wp: "16.68 MWp", status: "ongoing" },
    Guna: { wp: "2.32 MWp", status: "ongoing" },
    Harda: { wp: "2.40 MWp", status: "ongoing" },
    Satna: { wp: "2.40 MWp", status: "ongoing" },
    Sehore: { wp: "2.40 MWp", status: "ongoing" },
    Shajapur: { wp: "580 MWp", status: "ongoing" },
  };
          ...
          <Box width="100%" sx={{ aspectRatio: "4 / 3", maxWidth: "2000px" }}>
            <Suspense fallback={<CircularProgress color="primary" />}>
              <ComposableMap
                ...
                projectionConfig={{ scale: 4400, center: [77.65, 23.7] }}
